...
- Fixed various status checks in `Utilities.get_fallback` (#3082)
- Fixed getting [`ConstraintBasisStatus`](@ref) in
...
- Fixed `head_to_set` for custom sets in MathOptFormat (#3089)
- Fixed list of `_SUPPORTED_VERSIONS` in MathOptFormat (#3091)
