...
In addition, there is a special case for adding variables to existing linear problems.
    ...
    addvariable!(m::AbstractInstance, cref::Vector{Union{AffineConstraintRef{NonPositive}, AffineConstraintRef{NonNegative}, AffineConstraintRef{Zero}, AffineConstraintRef{Interval}}}, coefs)::VariableReference
