...
const IndicatorActiveOnFalse{T,F,S,OT<:MOI.ModelLike} =
    SingleBridgeOptimizer{IndicatorActiveOnFalseBridge{T,F,S},OT}

include("indicator_sos.jl")
const IndicatortoSOS1{T,BC<:MOI.AbstractScalarSet,MaybeBC,OT<:MOI.ModelLike} =
    SingleBridgeOptimizer{IndicatorSOS1Bridge{T,BC,MaybeBC},OT}
