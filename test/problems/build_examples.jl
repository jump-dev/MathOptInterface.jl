...
MOI.write(m, joinpath(Pkg.dir("MathOptFormat"), "test", "problems", "linear1.mof.json"), 1)
...
MOI.set!(m, MOI.ObjectiveSense(), MOI.MinSense)
MOI.write(m, joinpath(Pkg.dir("MathOptFormat"), "test", "problems", "linear2.mof.json"), 1)
...
MOI.set!(m, MOI.ObjectiveSense(), MOI.MinSense)
MOI.write(m, joinpath(Pkg.dir("MathOptFormat"), "test", "problems", "LIN1.mof.json"), 1)
...
MOI.write(m, joinpath(Pkg.dir("MathOptFormat"), "test", "problems", "LIN2.mof.json"), 1)
...
MOI.write(m, joinpath(Pkg.dir("MathOptFormat"), "test", "problems", "mip01.mof.json"), 1)
...
MOI.set!(m, MOI.ObjectiveSense(), MOI.MaxSense)
MOI.write(m, joinpath(Pkg.dir("MathOptFormat"), "test", "problems", "sos1.mof.json"), 1)
