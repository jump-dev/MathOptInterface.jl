...
- Fix LazyBridgeOptimizer with bridge that add no constraints (#689).
- Error messages improvements (#673, #685, #686, #688).
...
- Fix inferrence of `NumberOfVariables` and `NumberOfConstraints` (#677).
